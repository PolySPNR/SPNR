...
namespace SPNR.Core.Migrations
{
    ...
    internal class ScWorkContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            {
                b.HasOne("SPNR.Core.Models.Works.ScientificWork", "ScientificWork")
                    .WithOne("JournalPublish")
                    .HasForeignKey("SPNR.Core.Models.Works.PublishData.JournalPublish", "ScientificWorkId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();
            ...
            modelBuilder.Entity("SPNR.Core.Models.AuthorInfo.Department", b => { b.Navigation("Authors"); });

            modelBuilder.Entity("SPNR.Core.Models.AuthorInfo.Faculty", b => { b.Navigation("Departments"); });

            modelBuilder.Entity("SPNR.Core.Models.AuthorInfo.Organization", b => { b.Navigation("Faculties"); });

            modelBuilder.Entity("SPNR.Core.Models.Works.ScientificWork", b =>
            {
                b.Navigation("ELibInfo");

                b.Navigation("JournalPublish");
            });
